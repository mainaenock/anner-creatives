...
export default function AdminPage() {
  ...
  return <main className="flex min-h-screen flex-col bg-[#f6fbfe] text-[#17233b]"><SiteHeader/>
    <section className="mx-auto w-full max-w-[1400px] flex-1 px-4 py-8 sm:px-8 sm:py-10 lg:px-12"><div><p className="eyebrow">Protected workspace</p><h1 className="mt-2 font-serif text-3xl font-bold sm:text-5xl">Admin <span className="brush-text">dashboard</span></h1><p className="mt-2 text-sm text-slate-500">Add, edit and remove products stored in Cloudflare D1 and R2.</p></div>
